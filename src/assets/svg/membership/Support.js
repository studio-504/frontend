...
const Support = ({ fill = '#333' }) => (
  <Svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <G fill={fill} stroke={fill} strokeLinecap="square" strokeWidth="1.5">
      ...
      <Ellipse cx="12" cy="12" fill="none" rx="11" ry="11" stroke="#111111" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -4.9706 12)"/>
      <Ellipse cx="12" cy="12" fill="none" rx="5" ry="5" stroke="#111111" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -4.9706 12)"/>
    </G>
  </Svg>
)
