...
export const chatGetChatsFailure = createFailureAction(constants.CHAT_GET_CHATS_FAILURE)
...
export const chatGetChatFailure = createFailureAction(constants.CHAT_GET_CHAT_FAILURE)
...
export const chatCreateDirectFailure = createFailureAction(constants.CHAT_CREATE_DIRECT_FAILURE)
...
export const chatAddMessageFailure = createFailureAction(constants.CHAT_ADD_MESSAGE_FAILURE)
...
export const chatReportViewFailure = createFailureAction(constants.CHAT_REPORT_VIEW_FAILURE)
...
export const chatDeleteMessageFailure = createFailureAction(constants.CHAT_DELETE_MESSAGE_FAILURE)
...
export const chatFlagMessageFailure = createFailureAction(constants.CHAT_FLAG_MESSAGE_FAILURE)
